...
const dropdowns = ["Category", "Price", "Sex", "Gift"];
...
export default function GiftsHeader() {
  return (
    <div className="flex flex-col gap-6 md:gap-8">
      {/* Title */}
      <div>
        <h1 className="text-[26px] sm:text-[30px] md:text-[34px] lg:text-[36px] text-dark leading-tight font-poppins font-[600] mb-2">
