    ...
    <div className="flex min-h-[320px] flex-col items-center justify-center px-2 text-center sm:min-h-[340px]">
      <div className="w-full max-w-[540px] space-y-8">
        ...
        <div className="flex items-center justify-center gap-4">
          <BackButton
            onClick={onBack}
            className="flex h-[45px] min-w-[112px] items-center justify-center rounded-[16px] bg-[#F3EFFB] px-5 text-[#3300C9] transition-colors hover:bg-[#ECE6FB]"
          ...
          <ModalButton
            ...
            className="max-w-[146px] !h-[45px] rounded-[16px] px-6 text-[18px]"
          >
            {nextLabel}
          </ModalButton>
        </div>
